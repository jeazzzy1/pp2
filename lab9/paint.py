        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_r:
                    ...
                    tool = 'square'  # Добавляем квадрат
                elif event.key == pygame.K_p:
                    tool = 'rhombus'  # Добавляем ромб
                elif event.key == pygame.K_o:
                    tool = 'triangle'  # Добавляем треугольник
            if event.type == pygame.MOUSEBUTTONDOWN:
                if tool == 'line':
                    ...
                    if event.button == 1:
                        draw_square(screen, pygame.mouse.get_pos())
                elif tool == 'rhombus':  # Рисование ромба
                    if event.button == 1:
                        draw_rhombus(screen, pygame.mouse.get_pos())
                elif tool == 'triangle':  # Рисование треугольника
                    if event.button == 1:
                        draw_triangle(screen, pygame.mouse.get_pos())
...
def draw_square(screen, pos):
    pygame.draw.rect(screen, (255, 0, 0), (pos[0], pos[1], 100, 100))

# Функция рисования ромба
def draw_rhombus(screen, pos):
    points = [(pos[0] + 50, pos[1]), (pos[0], pos[1] + 50), (pos[0] + 50, pos[1] + 100), (pos[0] + 100, pos[1] + 50)]
    pygame.draw.polygon(screen, (255, 255, 0), points)

# Функция рисования треугольника
def draw_triangle(screen, pos):
    points = [(pos[0], pos[1] + 100), (pos[0] + 50, pos[1]), (pos[0] + 100, pos[1] + 100)]
